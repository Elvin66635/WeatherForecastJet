...
import com.example.weatherforecastjet.R
import com.example.weatherforecastjet.model.WeatherItem
import com.example.weatherforecastjet.utils.formatDate
import com.example.weatherforecastjet.utils.formatDateTime
import com.example.weatherforecastjet.utils.formatDecimals
...
fun WeatherDetailRow(weather: WeatherItem) {
    ...
    Surface(
        modifier = Modifier
            .padding(3.dp)
            .fillMaxWidth(), shape = CircleShape.copy(topEnd = CornerSize(4.dp)),
        color = Color.White
    ) {
        Row(
